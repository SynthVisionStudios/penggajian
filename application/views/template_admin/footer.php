...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [
        <?php echo $this->db->query("select status from data_pegawai where status='Karyawan Tetap'")->num_rows(); ?>,
      ...
      hoverBackgroundColor: ['rgb(255, 0, 0)', 'rgb(0, 0, 255)', 'rgb(255, 0, 0)', 'rgb(221, 223, 235)'],
...
var myBarChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: ['rgb(23, 125, 255)', 'rgb(255, 0, 0)'],
      data: [
